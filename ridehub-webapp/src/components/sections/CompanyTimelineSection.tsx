        ...
        <div className="space-y-10">
          {timelineEvents.map((event) => (
            <div key={event.id} className="timeline-item relative md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className={cn('md:text-right md:pr-12 pt-1', event.highlight && '')}>
                <span className="font-display text-2xl font-bold gradient-text">{event.year}</span>
              </div>
              <div className="md:pl-12 mt-2 md:mt-0">
                <div className={cn('p-6 rounded-2xl glass-card hover:border-primary/20 transition-colors', event.highlight && 'ring-1 ring-primary/20')}>
